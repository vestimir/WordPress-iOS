...
- (void)setup {
    ...
    button.titleLabel.shadowColor = [UIColor colorFromHex:0x000000 alpha:0.45f];
    button.titleLabel.shadowOffset = CGSizeMake(0, -1.0f);
    button.titleLabel.lineBreakMode = NSLineBreakByClipping;
    button.titleLabel.adjustsFontSizeToFitWidth = YES;
    button.titleLabel.minimumScaleFactor = 0.8f;
    ...
    label.minimumScaleFactor = 0.8f; // 15.0f * 0.8 => 12.0f
    label.shadowColor = [UIColor colorFromHex:0x000000 alpha:0.45f];
...
- (void)showSuccess {
    ...
    [UIView animateWithDuration:0.6f animations:^{
        ...
        label.textColor = [UIColor colorFromRGBAWithRed:200.0f green:228.0f blue:125.0f alpha:1.0f];
