...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.textLabel.textColor = [UIColor colorFromHex:0x030303];
        ...
        self.detailTextLabel.textColor = [UIColor colorFromHex:0x323232];
        ...
        self.unreadIndicator.textColor = [UIColor colorFromHex:0x008EBE];
