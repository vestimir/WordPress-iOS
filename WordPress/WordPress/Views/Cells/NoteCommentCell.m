...
- (void)prepareButton:(UIButton *)button {
    ...
    [button setTitleColor:[UIColor colorFromHex:0x5F5F5F] forState:UIControlStateHighlighted];
...
- (void)displayAsParentComment {
    ...
    [self.profileButton setTitleColor:[UIColor colorFromHex:0x287087] forState:UIControlStateNormal];
}
