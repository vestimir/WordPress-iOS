...
static NSString *const KVO_VC_TOOLBARITEMS = @"toolbarItems";
...
- (void)wrapViewFromController:(UIViewController *)controller {
    ...
    [self.viewController addObserver:self forKeyPath:KVO_VC_TOOLBARITEMS options:NSKeyValueObservingOptionNew context:NULL];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if ([keyPath isEqualToString:KVO_VC_TOOLBARITEMS]) {
         [[NSNotificationCenter defaultCenter] postNotificationName:@"wpToolbarChanged" object:object userInfo:nil];
    }
}
