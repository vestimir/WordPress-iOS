...
@implementation EditPostViewController {
    ...
    EditorKeyboardToolbar *editorToolbar;
    UIView *currentView;
    BOOL isEditing;
...
- (void)viewDidLoad {
    ...
    if (editorToolbar == nil) {
        ...
        editorToolbar = [[EditorKeyboardToolbar alloc] initWithFrame:frame];
    ...
    UIColor *color = [UIColor colorFromHex:0x222222];
...
- (void)logWPKeyboardToolbarButtonStat:(EditorKeyboardToolbarButtonItem *)buttonItem {
