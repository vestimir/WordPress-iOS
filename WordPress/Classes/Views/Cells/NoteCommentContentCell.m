...
- (void)displayAsParentComment {
    ...
    NSDictionary *stringAttributes = [NSDictionary dictionaryWithObject:(__bridge id)[UIColor colorFromHex:0x464646].CGColor forKey:(id)kCTForegroundColorAttributeName];
