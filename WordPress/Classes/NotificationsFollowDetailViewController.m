...
- (void)viewDidLoad
{
    ...
    if (headerText) {
        ...
        [headerLabel setBackgroundColor:[UIColor colorFromHex:0xDEDEDE]];
        [headerLabel setTextAlignment:NSTextAlignmentCenter];
        [headerLabel setTextColor:[UIColor colorFromHex:0x5F5F5F]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        if (cell == nil) {
            ...
            cell.textLabel.textColor = [UIColor colorFromHex:0x0074A2];
...
- (IBAction)highlightButton:(id)sender {
    [_postTitleButton setBackgroundColor:[UIColor colorFromHex:0xE3E3E3]];
}
