...
@interface WPAvatarSource ()

@property (nonatomic, strong) NSCache *gravatarCache;
@property (nonatomic, strong) NSCache *blavatarCache;
...
{
    static WPAvatarSource *sharedSource = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedSource = [[WPAvatarSource alloc] init];
    });
    return sharedSource;
}
...
- (void)processImage:(UIImage *)image forHash:(NSString *)hash type:(WPAvatarSourceType)type size:(CGSize)size success:(void (^)(UIImage *image))success
{
