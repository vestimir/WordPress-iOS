...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (media.remoteStatus == MediaRemoteStatusFailed) {
        [media uploadWithSuccess:^{
            ...
            [UIAlertView showAlertWithError:error title:NSLocalizedString(@"Upload failed", @"")];
        }];
...
- (NSFetchedResultsController *)resultsController {
    ...
    [fetchRequest setEntity:[NSEntityDescription entityForName:@"Media" inManagedObjectContext:[WordPressDataModel sharedDataModel].managedObjectContext]];
